              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-md font-medium text-gray-900 AstranovaHeroFont tracking-widest">
                      Successfully sent!
                    </p>
                    <p className="mt-1 text-md text-gray-500 font-poppins">
                      Enjoy and explore more in celestra.
                    </p>
                  </div>
